const dayNumber = document.getElementById("list-days")
const monthNumber = document.getElementById("list-month")
const yearNumber = document.getElementById("list-year")
const currentYear = document.querySelector('#y-list')
...
function dob(){
    for(let k = 1916; k < 2024; k++){
        yearNumber.appendChild(years(k));
    }
    for(let j = 1; j < months.length; j++){
        monthNumber.appendChild(month(j))
    }
    days(31);
